...
--
-- Tabela para confirmação. Exibe informações sobre as tabelas presentes no banco de dados atualmente conectado. Exibe uma lista detalha-- da de todas as tabelas, incluindo seus nomes, esquemas, tipos de tabela, tamanhos estimados em disco e proprietários das tabelas além-- da descrição de cada tabela.
--
